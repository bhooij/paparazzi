...
extern void CalculateSectorAverages (struct image_t *input_img,uint16_t y_start, uint8_t sector_h, uint8_t sector_w, uint16_t **output_array);
extern bool safeToGoForwards(uint16_t **input_array);
